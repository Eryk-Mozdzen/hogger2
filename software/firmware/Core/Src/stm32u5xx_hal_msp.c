...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PB10     ------> SPI2_SCK
    */
    GPIO_InitStruct.Pin = FLOW_MISO_Pin|FLOW_MOSI_Pin;
    ...
    GPIO_InitStruct.Pin = FLOW_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(FLOW_SCK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, FLOW_MISO_Pin|FLOW_MOSI_Pin);

    HAL_GPIO_DeInit(FLOW_SCK_GPIO_Port, FLOW_SCK_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, NRF_SCK_Pin|NRF_MISO_Pin|NRF_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = SERVO_X1_Pin|SERVO_Y1_Pin|SERVO_X2_Pin|SERVO_Y2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
