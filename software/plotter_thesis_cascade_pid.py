...
plt.figure()
plt.plot(data['timestamp'], np.array(data['trajectory'][2]), linestyle='dashed', color='black')
...
plt.plot(data['timestamp'], data['motor_1']['vel'], color='red')
plt.xlabel('time [s]')
...
plt.plot(data['timestamp'], data['motor_2']['vel'], color='green')
plt.xlabel('time [s]')
