...
plt.figure()
plt.subplot(2, 1, 1)
plt.plot(file['t'].values, file['dphi1'].values, label='$\\dot{\\phi}_1$')
plt.plot(file['t'].values, file['dtheta1'].values, label='$\\dot{\\theta}_1$')
plt.plot(file['t'].values, file['dpsi1'].values, label='$\\dot{\\psi}_1$')
plt.plot(file['t'].values, file['dtheta2'].values, label='$\\dot{\\theta}_2$')
plt.plot(file['t'].values, file['dpsi2'].values, label='$\\dot{\\psi}_2$')
plt.title('control signals')
plt.xlabel('t [s]')
plt.ylabel('$\\dot{\\eta}$ [rad/s]')
